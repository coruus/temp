...
ALIGN(64) static const uint32_t blake2s_IV[8] = {0x6A09E667UL,
                                                 0xBB67AE85UL,
                                                 0x3C6EF372UL,
                                                 0xA54FF53AUL,
                                                 0x510E527FUL,
...
static inline int blake2s_param_set_salt(
    blake2s_param* P,
...
static inline int blake2s_param_set_personal(
    blake2s_param* P,
...
int blake2s_final(blake2s_state* S, uint8_t* out, uint8_t outlen) {
  ...
  memset(
      S->buf + S->buflen, 0, 2 * BLAKE2S_BLOCKBYTES - S->buflen); /* Padding */
  blake2s_compress(S, S->buf);
